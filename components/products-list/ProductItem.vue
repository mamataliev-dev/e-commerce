<template>
  <div
    class="relative h-[460px] bg-white p-4 rounded-lg flex flex-col justify-start cursor-pointer"
  >
    <!-- Img -->
    <div class="relative">
      <img
  ...
  >
    ...
    <div class="flex-1">
      ...
      <div class="flex items-center space-x-0.5 mt-1">
        ...
        <span class="text-sm text-borderGray">4.9</span>
        <span class="text-sm text-borderGray">(4 reviews)</span>
      </div>
    </div>

    <div class="relative flex items-end justify-between space-x-6 mt-6">
      <div>
        <span class="absolute -top-6 line-through text-borderGray">$699</span>
